 ...
 * @since 1.0
 */
class Myour_Resume_Widget extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Resume', 'myour-plugin' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'date', [
				'label'       => esc_html__( 'Date', 'myour-plugin' ),
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'placeholder' => esc_html__( 'Enter date', 'myour-plugin' ),
				'default'	=> esc_html__( 'Enter date', 'myour-plugin' ),
			]
		);
		...
		$this->add_control(
			'item_date_color',
			[
				'label'     => esc_html__( 'Date Color', 'myour-plugin' ),
				'type'      => Controls_Manager::COLOR,
				'default'	=> '',
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label'     => esc_html__( 'Date Typography', 'myour-plugin' ),
			...
			<div class="content">
				...
				<div class="content-carousel">
					<div class="owl-carousel" data-slidesview="2" data-slidesview_mobile="1">
					    ...
					    ?>
						<div class="item">
							<div class="resume-item<?php if ( $index == 0 ) : ?> active<?php endif; ?>">
								<div class="date">
			...
			<div class="content">
				...
				<div class="content-carousel">
					<div class="owl-carousel" data-slidesview="2" data-slidesview_mobile="1">
					    ...
					    #>
						<div class="item">
							<div class="resume-item<# if ( index == 0 ) { #> active<# } #>">
								<div class="date">
...
Plugin::instance()->widgets_manager->register_widget_type( new Myour_Resume_Widget() );