...
final class SSO {
	...
	public function login_init() {
		...
		if ( ! $enabled || WP_DEBUG || ! Plugin::is_gd() || ! defined( 'GD_ACCOUNT_UID' ) || ! GD_ACCOUNT_UID || (bool) filter_input( INPUT_GET, 'wpaas-standard-login' ) || has_action( 'login_form' ) || has_action( 'login_enqueue_scripts' ) ) {
