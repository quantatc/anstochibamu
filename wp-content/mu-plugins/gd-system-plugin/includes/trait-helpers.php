...
trait Helpers {
    ...
    public static function get_update_php_alert_text() {
         ...
         */
        if (self::is_gd()) {
            $format = __('Your WordPress installation is using an unsupported PHP version (' . PHP_VERSION . ').
                    You run the risk of crashing your site, unless you take action and update your site PHP. <a href="%s" target="_blank" >Read more</a>');
            $link = "https://godaddy.com/help/a-41164";
        ...
        if (in_array(GD_RESELLER, $reseller_brands)) {
            return __('Your WordPress installation is using an unsupported PHP version (' . PHP_VERSION . '). You run the risk of crashing your site, unless you take action and update your site PHP. Contact support for more info.');
        }
        /**
         * Default value For resellers.
         */
        $format = __('Your WordPress installation is using an unsupported PHP version (' . PHP_VERSION . '). You run the risk of crashing your site, unless you take action and update your site PHP. <a href="%s" target="_blank" >Read more</a>');
        $link = "https://www.secureserver.net/help/a-41164?pl_id=" . GD_RESELLER;
	...
	/**
	 * Check if this site is an ecommerce plan.
	 *
	 * @since 4.23.5
	 *
	 * @return bool
	...
	public static function is_ecommerce_plan() {
		...
		return strpos( strtolower( GD_PLAN_NAME ), 'ecommerce managed wordpress' ) !== false;
	...
	/**
	 * Return if GD_PLAN_NAME contains WordPress Design Service.
	 *
	 * @return boolean
	 */
	public static function is_wds() {

		return (bool) ( defined( 'GD_PLAN_NAME' ) && false !== strpos( GD_PLAN_NAME, 'WordPress Design Service' ) ) || self::is_plugin_active( 'pws-core/core.php' );
