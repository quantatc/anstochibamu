...
class ManagedWooCommerceRepository
{
    ...
    /**
     * Returns plan information depending on Platform.
     *
     * @return string|null
     */
    public static function getPlan()
    {
        //for now this simply passes thru, in future there will be other platforms {WS 2022-01-14}
        return static::getManagedWordPressPlan();
    }

    /**
     * Returns name of platform, with default if can't detect.
     * NB: in future this should handle additional platforms.
     *
     * @return string
     */
    ...
    {
        return Configuration::get('godaddy.customerId');
    }
    ...
    {
        return Configuration::get('godaddy.ventureId');
    }
}
